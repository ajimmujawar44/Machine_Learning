...
st.title("Salary Prediction App created by Azim Mujawar")
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by Azim Mujawar")
